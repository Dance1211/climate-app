...
export const seed = async (clientConnection: MongoClient, data: Array<KGCode>): Promise<void> => {
	...
	const kgCodeCollection: Collection<KGCode> = db.collection(process.env['MONGODB_KGCODES']);
